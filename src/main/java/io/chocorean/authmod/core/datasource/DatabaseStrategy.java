...
public class DatabaseStrategy implements DataSourceStrategyInterface {
  ...
  public enum Column {IDENTIFIER, USERNAME, UUID, PASSWORD, BANNED}
  private final PasswordHashInterface passwordHash;
  private final ConnectionFactoryInterface connectionFactory;

  public DatabaseStrategy(String table, ConnectionFactoryInterface connectionFactory, Map<Column, String> customColumns, PasswordHashInterface passwordHash) throws SQLException {
    this.table = table;
